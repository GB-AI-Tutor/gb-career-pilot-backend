...
In the interest of fostering an open and welcoming environment, we as contributors and maintainers of **GB Career Pilot** under **Feel and Support** pledge to make participation in our project and our community a harassment-free experience for everyone, regardless of age, body size, disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.
...
✅ **Being patient** with beginners and newcomers
...
- Discord server (all channels)
- Project events (online or in-person)
- Social media accounts
- Email communications
- Any other forum representing the project
...
- **Email:** conduct@feelandsupport.org
...
1. **Acknowledgment:** Reporter receives acknowledgment within 24 hours
2. **Investigation:** Maintainers review the incident
3. **Decision:** Appropriate action is determined
4. **Communication:** All involved parties are informed
5. **Follow-up:** Ongoing monitoring if needed
...
- **Be patient** when reviewing code
...
As a student-led project, we especially value:
...
- **Email:** conduct@feelandsupport.org
- **Discord:** Ask any moderator
- **GitHub:** Open an issue with `conduct` label
...
By participating in this project, you agree to abide by this Code of Conduct. We appreciate your cooperation in making GB Career Pilot a welcoming and productive community!
